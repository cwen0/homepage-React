      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <span className="footer-gray-text">PuckPuck Labs</span>
            ...
            <div className="footer-gray-container3">
              ...
              <a
                href="https://github.com/puckpucklabs"
                target="_blank"
                rel="noreferrer noopener"
              ...
              <a
                href="https://www.youtube.com/channel/UC4OwT4QTd0ML3YNnV1ybT6g"
                target="_blank"
                rel="noreferrer noopener"
          ...
          <div className="footer-gray-container4">
            <div className="footer-gray-container5">
              ...
              <span className="footer-gray-text3 large">About Us</span>
            </div>
            <div className="footer-gray-container6">
              <span className="footer-gray-text4 large">Resources</span>
              <a
            ...
            <div className="footer-gray-container7">
              <span className="footer-gray-text5 large">
                Help &amp; Support
              </span>
              <a
        ...
        <span className="footer-gray-text6 small">
          <span>All rights reserved. Copyright © 2022 PuckPuck Labs</span>
          <span>.</span>
        </span>
      </div>
    </footer>
